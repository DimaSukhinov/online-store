...
type LogoIdType = 'HEADER_LOGO' | 'HEADER-VECTOR' | 'HEADER-EMPTY-CART' | 'ADD-TO-CART'

type SvgSelectorType = {
    id: LogoIdType
}

export const SvgSelector = React.memo((props: SvgSelectorType) => {
    switch (props.id) {
        case 'HEADER_LOGO':
            return <svg width="41" height="41" viewBox="0 0 41 41" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <defs>
                    <linearGradient id="paint0_linear_150_357" x1="29.8733" y1="31.3337" x2="11.5132" y2="9.9008"
